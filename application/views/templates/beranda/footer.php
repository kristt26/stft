...
<!-- 
    <footer class="site-footer">
     ...
     <!-- SCRIPTS -->
     <script src="<?= site_url() ?>lain/js/jquery.min.js"></script>
     <script src="<?= site_url() ?>lain/js/bootstrap.min.js"></script>
     <script src="<?= site_url() ?>lain/js/aos.js"></script>
     <script src="<?= site_url() ?>lain/js/owl.carousel.min.js"></script>
     <script src="<?= site_url() ?>lain/js/custom.js"></script>
