...
<script>
    var x = setInterval(function() {
        $.ajax({
            ...
            //     'msg': [{
            //         "messageId": "6",
            //         "date": "2021-07-31 11:42:02",
            //         "dari": "6282238281801",
            //         "isiPesan": "Hasil CM-006-19"
            //     }]
            // }
            console.log(data);
            if (data.status == undefined) {
                data.msg.forEach(element => {
                    ...
                    $.ajax({
                        url: "<?= base_url("sms/kirim/"); ?>" + kode[0] + "/" + kode[1] + "/" + element.dari,
                        context: document.body
                    }).done(function(x) {
    ...
    function hapusUjian(kd_ujian) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "http://localhost/stft/admin/hapus_ujian/" +
                        kd_ujian,
                    dataType: "json",
    ...
    function hapusTahun(kd_tahun) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "http://localhost/stft/admin/hapus_tahun/" +
                        kd_tahun,
                    dataType: "json",
                    success: function(obj) {
                        swal
    ...
    function hapusGelombang(kd_gelombang) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "http://localhost/stft/admin/hapus_gelombang/" +
                        kd_gelombang,
                    dataType: "json",
                    success: function(obj) {
                        swal
    ...
    function hapusSoal(kd_soal) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "http://localhost/stft/admin/hapus_soal/" +
                        kd_soal,
                    dataType: "json",
                    success: function(obj) {
                        swal
    ...
    function hapusStandar(kd_standar) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "http://localhost/stft/admin/hapus_standar/" +
                        kd_standar,
                    dataType: "json",
                    success: function(obj) {
                        swal
    ...
    function hapusBerita(kd_berita) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "http://localhost/stft/admin/hapus_berita/" +
                        kd_berita,
                    dataType: "json",
                    success: function(obj) {
                        swal
    ...
    function hapusJadwal(kd_jadwal) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "http://localhost/stft/admin/hapus_jadwal/" +
                        kd_jadwal,
                    dataType: "json",
                    success: function(obj) {
                        swal
