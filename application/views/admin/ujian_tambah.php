                            ...
                            <div class="col-sm-8">
                             <form action="" method="post">
                                ...
                                <div class="form-group <?php echo form_error('kd_ujian') ? 'has-error' : null ?>">
                                    ...
                                    <input type="hidden" class="form-control" placeholder="KD Ujian" name="kd_ujian" value="U-<?php echo sprintf("%0s", $kd_ujian) ?>" readonly>
                        ...
                        <!-- <div class="row">
                            <div class="col-sm-8"> -->
                                <div class="form-group <?php echo form_error('nama_ujian') ? 'has-error' : null ?>">
                                    ...
                                    <input type="text" class="form-control" placeholder="Masukan Data Ujian..." name="nama_ujian" autocomplete="off"  value="<?php echo set_value('nama_ujian'); ?>" >
