        ...
        <br><br>
          <div class="card">
            ...
            <?php if($periksa==null) { ?>
              ...
              <h3 class="card-title"><p>Kode Calon Mahasiswa: <?= $periksa[0]['kd_maba']; ?></p>
              <p>Nama: <?= $periksa[0]['nama']; ?></p>
              <!-- <p>Jenis Kelamin:  <?= $periksa[0]['jenis_kelamin']; ?> </p>  -->
              <p>Ujian:  <?= $periksa[0]['nama_ujian']; ?> </p> </h3></div>
            <!-- /.card-header -->
            <div class="card-body">
              ...
              <input type="hidden" name="kd_hasil_ujian" value="HU-<?php echo sprintf("%03s", $kd_hasil_ujian) ?>">
