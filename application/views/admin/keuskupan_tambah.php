                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-8">
                                    <form action="" method="post">
                                        ...
                                        <div
                                            ...
                                            <input type="hidden" class="form-control" placeholder="KD Keuskupan"
                                                name="kd_keuskupan"
                                                value="K-<?php echo sprintf("%02s", $kd_keuskupan) ?>" readonly>
                            ...
                            <div class="form-group <?php echo form_error('nama_keuskupan') ? 'has-error' : null ?>">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan Nama Keuskupan..."
                                    name="nama_keuskupan" autocomplete="off"
                                    value="<?php echo set_value('nama_keuskupan'); ?>">
                            ...
                            <div class="form-group <?php echo form_error('alamat') ? 'has-error' : null ?>">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan Alamat Keuskupan..."
                                    name="alamat" autocomplete="off" value="<?php echo set_value('alamat'); ?>">
                                <?php echo form_error('alamat'); ?>
                            </div>
                            <br>
                        </div>
                        <div class="card-footer">
                            <a href="<?= site_url('admin/keuskupan_data'); ?>" class="btn btn-danger"><i
