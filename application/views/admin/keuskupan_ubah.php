                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <?php foreach($keuskupan as $ks) : ?>
                             <form action="<?= site_url('admin/keuskupan_edit_proses') ?>" method="post">
                                
                                <div class="form-group <?php echo form_error('kd_keuskupan') ? 'has-error' : null ?>">
                                    <!-- <label for="kd_keuskupan">KD Keuskupan</label> -->
                                    <input type="hidden" class="form-control" placeholder="KD Keuskupan" name="kd_keuskupan" value="<?= $ks['kd_keuskupan']; ?>" readonly>
                        ...
                        <!-- <div class="row">
                            <div class="col-sm-8"> -->
                                <div class="form-group <?php echo form_error('nama_keuskupan') ? 'has-error' : null ?>">
                                    ...
                                    <input type="text" class="form-control" placeholder="Masukan Nama Keuskupan..." name="nama_keuskupan" autocomplete="off"  value="<?= $ks['nama_keuskupan']; ?>" >
                        ...
                        <!-- <div class="row">
                            <div class="col-sm-8"> -->
                                <div class="form-group <?php echo form_error('alamat') ? 'has-error' : null ?>">
                                    ...
                                    <input type="text" class="form-control" placeholder="Masukan Alamat Keuskupan..." name="alamat"  autocomplete="off" value="<?= $ks['alamat']; ?>">
