            ...
            <table id="example1" class="table table-striped">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <?php if($db==null) { ?>
                      <a href="<?= site_url('admin/periksa_ujian/') . $jd['kd_ujian'] . '/' . $maba['kd_maba'];  ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Periksa</a> </p>
                    <?php } else { ?>
                        
                          <button class="btn btn-success btn-sm"><i class="fas fa-check"></i> Sudah diperiksa</button>
                    <?php } ?>
                  </td>
