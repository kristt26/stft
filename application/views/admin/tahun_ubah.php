                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <?php foreach($tahun_ajaran as $ta) : ?>
                             <form action="<?= site_url('admin/tahun_edit_proses') ?>" method="post">
                                
                                <div class="form-group <?php echo form_error('kd_tahun_ajaran') ? 'has-error' : null ?>">
                                    <!-- <label for="kd_keuskupan">KD Keuskupan</label> -->
                                    <input type="hidden" class="form-control" placeholder="KD Tahun Ajaran" name="kd_tahun_ajaran" value="<?= $ta['kd_tahun_ajaran']; ?>" readonly>
                        ...
                        <!-- <div class="row">
                            <div class="col-sm-8"> -->
                                <div class="form-group <?php echo form_error('tahun_ajaran') ? 'has-error' : null ?>">
                                    ...
                                    <input type="text" class="form-control" placeholder="Masukan Data Tahun Ajaran..." name="tahun_ajaran" autocomplete="off"  value="<?= $ta['tahun_ajaran']; ?>" >
