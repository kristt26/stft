            ...
            <div class="col-md-12">
                ...
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" placeholder="KD Soal" name="kd_maba" value="<?= $kd_maba ?>" readonly>
                            ...
                            <div class="col-sm-8">
                                <div class="form-group <?php echo form_error('tempat_lahir') ? 'has-error' : null ?> ">
                                    ...
                                    <input type="text" class="form-control" placeholder="Masukan Tempat Lahir..." name="tempat_lahir" autocomplete="off">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group <?php echo form_error('tanggal_lahir') ? 'has-error' : null ?> ">
                                    ...
                                    <input type="date" class="form-control" placeholder="Masukan Tanggal Lahir..." name="tanggal_lahir" autocomplete="off">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group <?php echo form_error('no_hp') ? 'has-error' : null ?>">
                                    ...
                                    <input type="number" class="form-control" placeholder="Masukan nomor HP..." name="no_hp" autocomplete="off">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group <?php echo form_error('kd_keuskupan') ? 'has-error' : null ?>">
                                    ...
                                    <select class="form-control" name="kd_keuskupan">
                                      ...
                                      <option value="<?= $ks['kd_keuskupan']; ?>"><?= $ks['nama_keuskupan']; ?></option>
                                      <?php endforeach; ?>
                                    </select>
                    ...
                    <div class="card-footer"> 
                        <!-- <a href="<?= site_url('maba/daftar'); ?>" class="btn btn-danger"><i class="fa fa-times"></i> Batal</a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                              <div class="form-group">
                                  ...
                                  <input type="file" class="form-control" name="kartu_keluarga" autocomplete="off" required >
                            ...
                            <div class="col-sm-8">
                              <div class="form-group">
                                  ...
                                  <input type="file" class="form-control" name="surat_baptis" autocomplete="off" required >
